    ...
    <div className="home-container">
      <div className="info-home-container">
        ...
        <p>
          ...
          <br />
          <br />
          💬 En SecondHand Hub conectamos personas reales que quieren dar una
          nueva oportunidad a sus objetos. Publica tus productos, chatea con
          otros usuarios, encuentra lo que necesitas… todo en una plataforma
          segura, sencilla y 100% pensada para ti.
          <br />
          <br />✅ Seguro, rápido y sin complicaciones.
        </p>
      </div>
        ...
        {viewType === "LOG" ? (
          ...
          <>
            ...
            <div className="info-links-buttons-container">
              <button className="btn-to-login" onClick={() => handlerViewOption('LOG')}>Hacer login</button>
              <p>ó</p>
              <button className="btn-to-register" onClick={() => handlerViewOption('REG')}>Crear tu cuenta</button>
            </div>
          </>
        )}
      </div>
